...
export const ADMIN_LANCAR_JOGOS = Object.freeze({
  ...
  preliveMustInclude: Object.freeze([
    ...
    "publishDueScheduledMatches",
    "resolveMatchPublishState",
    "MANUAL_EXTERNAL_ID_CONFLICT",
  ]),
  rules: Object.freeze([
    "lançamento padrão = publicação imediata (is_published true)",
    "opção de agendar publicação (scheduled_publish_at)",
