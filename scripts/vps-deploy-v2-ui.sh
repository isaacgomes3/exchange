...
#
# Uso (root na VPS):
#   bash <(curl -fsSL "https://raw.githubusercontent.com/isaacgomes3/exchange/cursor/arbishield-v2-backup-723d/scripts/vps-deploy-v2-ui.sh?v=12")
set -euo pipefail
...
for f in v2.css v2.js v2-shell.js v2-pages.js v2-deposit.js v2-financeiro.js v2-provedor.js v2-afiliados.js; do
