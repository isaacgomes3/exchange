...
REF="${ARBISHIELD_REF:-c33e7804ade0a597f7f91fb40d7d282aa930228b}"
...
grep -qiE 'Criar Conta( Pro)?' "$WEB/cadastro.html" || die "cadastro.html sem Criar Conta"
grep -q 'id="fullName"' "$WEB/cadastro.html" || die "cadastro.html sem campo nome"
grep -q 'id="cpf"' "$WEB/cadastro.html" || die "cadastro.html sem campo CPF"
