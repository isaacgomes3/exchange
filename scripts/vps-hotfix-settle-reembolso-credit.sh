...
echo "Para migrar créditos legados do Saldo Real ao Reembolso:"
echo "  APPLY=1 MIGRATE_LEGACY_BUCKET=1 EMAIL=carloskku4@gmail.com node ${SCRIPTS_DIR}/vps-repair-settled-reembolso.mjs"
