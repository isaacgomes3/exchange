#!/usr/bin/env bash
# Header: chip Congelado (saldo bloqueado) no lugar de Provedor; Desafio à esquerda.
#
# Na VPS:
#   bash <(curl -fsSL "https://raw.githubusercontent.com/isaacgomes3/exchange/<SHA>/scripts/vps-hotfix-header-saldo-congelado.sh")
set -euo pipefail

REF="${ARBISHIELD_REF:-cursor/header-saldo-congelado-723d}"
...
log "1/1 UI — chips Desafio + Congelado no header"
...
log "OK — header: Apostador | Afiliado | Desafio | Congelado"
