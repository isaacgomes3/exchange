...
#     "https://api.github.com/repos/isaacgomes3/exchange/contents/scripts/vps-hotfix-admin-menu-accordion.sh?ref=cursor/protecao-v10-fonte-verdade-501d&t=$(date +%s)")
set -euo pipefail

# Fonte de verdade: branch v10 (accordion + anti-reversão). Não usar branches soltas.
