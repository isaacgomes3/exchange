...
15b. **Desafio — etapas liquidadas na grade:** `app-desafio.html` (`desafio-etapas-liquidadas-visiveis-v1`) mantém etapas liquidadas na tela (Bateu Arbi/Casa/Empate Anula), com CTA desabilitado; desafios `completed` do dia também entram. Teste: `desafio-etapas-liquidadas.test.mjs`.
