...
15b. **Desafio — reentrada após cancelar:** `desafio-reentrada-apos-cancelar-v1` — cancelar a própria entrada **permite** entrar de novo na mesma etapa, se a etapa ainda estiver aberta (antes do kickoff, não live/finalizada), o desafio ativo, e as regras do ciclo (saldo, pending, máx. entradas). Cancelada não conta no ciclo. Teste: `desafio-reentry-contract.test.mjs`.
